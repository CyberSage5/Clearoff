...
export default function product() {
  ...
  >
    <img
      ...
      alt="product image"
    />
    {/* <span className="absolute top-0 left-0 m-2 rounded-full bg-clRed px-2 text-center text-sm font-medium text-white">
      39% OFF
    </span> */}
  </a>
  <div className="mt-4 px-5">
    ...
    <div className="mt-2 mb-5 flex items-center justify-between">
      <p>
        <span className="text-3xl font-bold text-slate-900"><span className="">N</span> 449</span>
        <span className="text-sm text-slate-900 line-through">N 699</span>
      </p>
