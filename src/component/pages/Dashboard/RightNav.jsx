...
export default function RightNav () {
  ...
  return (
    ...
    <div className="h-full px-3 py-4">
       ...
       <li>
            <a href="#" className="flex items-center p-2 text-gray-800 rounded-lg hover:text-gray-50 hover:bg-clRed group">
            <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         <li>
             <a href="#" className="flex items-center p-2 text-gray-800 rounded-lg  hover:bg-clRed group">
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-gray-50 bg-gray-500 rounded-full 0 300 group-hover:text-clRed group-hover:bg-gray-50 group">6</span>
             </a>
          </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-800 rounded-lg  hover:bg-clRed group-hover:text-blue-50 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap group-hover:text-blue-50">My Products</span>
            </a>
         </li>
         <li>
             <a href="#" className="flex items-center p-2 text-gray-800 rounded-lg  hover:bg-clRed group">
             ...
             <path d="M18.045 3.007 12.31 3a1.965 1.965 0 0 0-1.4.585l-7.33 7.394a2 2 0 0 0 0 2.805l6.573 6.631a1.957 1.957 0 0 0 1.4.585 1.965 1.965 0 0 0 1.4-.585l7.409-7.477A2 2 0 0 0 21 11.479v-5.5a2.972 2.972 0 0 0-2.955-2.972Zm-2.452 6.438a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"/>
                ...
                <span className="flex-1 ms-3 whitespace-nowrap group-hover:text-blue-50">Upload Product</span>
             </a>
          </li>
          <li>
             <a href="#" className="flex items-center p-2 text-gray-800 rounded-lg  hover:bg-clRed group">
